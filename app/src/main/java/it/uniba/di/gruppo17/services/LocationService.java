package it.uniba.di.gruppo17.services;
...
public class LocationService extends Service {
    ...
    public void onCreate() {
        ...
        {
            String CHANNEL_ID ="MovingFast_notification";
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID,"MovingFastChannel", NotificationManager.IMPORTANCE_DEFAULT);
